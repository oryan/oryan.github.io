const summaries = [
  ...
  "{goodGuy.crewName} faces against a highly infectious plague that even the {ally.one} can't cure. {goodGuy.crewName} must make a decision: must destroy an {ally.one} infested vessel or let the crew of that ship die a slow death in the hope of finding a cure.",
  ...
  "An alien ship approaches {goodGuy.hq}, sending {goodGuy.crewName} to an old friend for some answers -- where they discover that someone unexpected has betrayed them.",
  ...
  "Dr. {goodGuy.one}son's undercover mission to a {badGuy.one} summit is complicated by the arrival of a surprise guest. Meanwhile, the rest of the team is buried under the surface of the {ally.three} homeworld after a {badGuy.one} attack.",
  ...
  "A teenage boy shows up at {goodGuy.hq} claiming to be {goodGuy.one}, sending the team on a mission to uncover his true identity.",
  ...
  "The impending wedding of a family member is the least of {goodGuy.three} 's worries when an uprising against the {badGuy.one}, drives a wedge between {goodGuy.three} and their partner.",
  ...
  "{goodGuy.hq} provides sanctuary for {goodGuy.five}'s estranged, con artist father after they provide intel about a {ally.two} plot to attack the planet.",
  ...
  "{goodGuy.crewName} investigates a problem off-world and soon finds that they have become victims themselves: they cannot stay awake. Meanwhile, {goodGuy.five} undergoes an evaluation on {goodGuy.hq}, hoping to join {goodGuy.crewName}.",
